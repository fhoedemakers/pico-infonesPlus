...
The emulator supports two player games using two NES controllers or an USB gamecontroller and a NES controller connected on controller port 2. The USB controller is always player 1.
