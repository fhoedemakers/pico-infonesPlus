...
- Fix missing HUD in Alien 3. Mapper 4 (MMC3) $E000 write now clears the CPU's pending IRQ, preventing a spurious second IRQ from re-entering the handler and disabling background rendering.
